...
fs.createReadStream('C:/Users/Mayank Sharma/Desktop/SBT-Token/vc_emails.csv')
  .pipe(csv())
  .on('data', (row) => {
    const name = row.name;
    ...
    const imagePath = 'C:/Users/Mayank Sharma/Desktop/SBT-Token/Image.jpg'; // Update this to the path of your local image file
    const mailOptions = {
